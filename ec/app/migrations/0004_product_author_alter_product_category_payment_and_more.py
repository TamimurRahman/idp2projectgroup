# Generated by Django 5.1.4 on 2025-05-02 19:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='category',
            field=models.CharField(choices=[('ML', 'Fiction'), ('CR', 'Non-Fiction'), ('LS', 'Science-Fiction'), ('MS', 'History'), ('PN', 'Fantasy'), ('GH', 'Ghee'), ('CZ', 'Cheese'), ('IC', 'Ice-Creams')], max_length=2),
        ),
